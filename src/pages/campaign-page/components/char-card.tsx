...
export default function CharacterCard({ character }: CharacterCardProps) {
  ...
  return (
    <Link
      ...
      className="bg-dark-bg-secondary space-x-5  items-center w-[95%]  hover:scale-105 duration-300 text-lg flex   rounded-2xl border border-primary text-foreground  px-5 py-5"
    >
