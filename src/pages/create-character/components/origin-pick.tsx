...
export default function OriginPick({ origin, setValue }: OriginProps) {
  ...
  return (
    <div className={`flex flex-col border-[3px] border-border  `}>
      ...
      >
        <h1 className="lg:text-3xl md:text-2xl text-base font-semibold">{origin.name}</h1>
      ...
      <div
        className={`lg:text-2xl md:text-lg text-base  font-normal flex flex-col space-y-5 overflow-x-auto overflow-y-hidden lg:px-16 md:px-12 px-8 duration-300 transition-max-height  ${
      ...
      >
        <div>
          ...
          <p
            className="text-[1.1rem] leading-7 font-light"
        ...
        <div>
          ...
          <label className="flex flex-col font-extralight text-lg">
