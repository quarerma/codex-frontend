  ...
  return selectedOrigin ? (
    <div className="flex flex-col justify-center items-center space-y-20">
      <div className="w-full  font-extralight flex justify-center space-x-20">
        <Button className="mt-5 text-4xl p-6 rounded-xl" variant={'secondary'} onClick={unselectOrigin}>
          Mudar Origem
        </Button>
        <div className="text-5xl bg-dark-bg-secondary border-[3px] w-[50%] border-border p-5 flex flex-col rounded-2xl space-y-10">
          <div className="space-y-5">
            <h1 className="font-bold text-5xl text-center">{selectedOrigin.name}</h1>
            <div className="w-full h-[2px] bg-muted"></div>
          </div>
          <div>
            <h3 className="font-bold mb-1">Descrição:</h3>
            <p className="text-[1.3rem] leading-7 font-extralight" dangerouslySetInnerHTML={{ __html: selectedOrigin.description }}></p>
          </div>
          <div>
            <h1 className="font-bold">Perícias Treinadas</h1>
            <ul className="list-disc list-inside text-3xl font-light">
          ...
          <div>
            ...
            <label className="flex flex-col font-extralight text-3xl">
    ...
    <div className="flex justify-center">
      <p className="w-[40%] text-[2rem] leading-[55px] ml-10 font-light ">
        O que seu personagem fazia antes de se envolver com o paranormal e ingressar na Ordem da Realidade? A origem representa como a vida pregressa influencia sua carreira de investigador.
        <br />
        Ao escolher uma origem, você recebe duas perícias treinadas e um poder da origem.
        <br /> Cada origem apresentada a seguir é intencionalmente vaga, apenas uma ideia por onde começar. Você pode usá-la como está, para jogar rapidamente, ou colorir com quantos detalhes quiser,
