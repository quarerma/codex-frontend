...
export default function CharacterPortrait({ character }: CampaignPortraitProps) {
  return (
    <Link
      to={`${character.id}`}
      className="bg-dark-bg-secondary w-[95%] hover:drop-shadow-[0_4px_50px_rgba(255,255,0,0.37)] hover:scale-105 duration-300 text-xl flex flex-col space-y-3  rounded-2xl border border-primary text-foreground font-romannew px-5 py-5"
    >
