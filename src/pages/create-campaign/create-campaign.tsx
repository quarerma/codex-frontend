  ...
  return (
    <PageSetup>
      <div className="relative space-y-10">
        <h1 className="text-5xl font-bold">Criar campanha</h1>
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col space-y-8 relative bg-dark-bg-secondary border-4 p-5 -mb-5 rounded-xl border-border ">
          <div>
            <h1 className="mb-4 text-4xl font-medium">Nome:</h1>
          ...
          <div>
            <h1 className="mb-4 text-4xl font-medium">Senha:</h1>
          ...
          <div>
            <h1 className="mb-4 text-4xl font-medium">Descrição:</h1>
