    ...
    <Sheet>
      <SheetTrigger className="flex flex-col border-[3px] border-border relative w-full">
        <div className="flex w-full items-center cursor-pointer lg:p-6 md:p-4 p-2">
          <h1 className="lg:text-4xl md:text-3xl text-xl font-semibold text-left ">{slot.local_name}</h1>

          <div className="flex items-center text-xl min-w-[150px] space-x-2 ml-auto mr-4">
            <span>
      ...
      <SheetContent className={`lg:text-4xl font-romannew md:text-2xl text-xl font-normal text-white flex flex-col overflow-x-hidden`}>
        ...
        <div className={`flex items-center text-lg justify-start space-x-5`}>
        ...
        {isEditing ? (
          <div className=" h-[250px]">
            <ReactQuill
              ...
              className={`text-xl bg-transparent h-[180px] `}
            />
          </div>
        ) : (
          <p className="text-xl" dangerouslySetInnerHTML={{ __html: slot.local_description }}></p>
        )}
        ...
        <div className="flex items-center text-lg justify-between pt-5">
          {isLoading ? (
            ...
            <Button onClick={isEditing ? handleSaveChanges : toggleEditMode} variant="link" className="text-primary ">
          ...
          {isLoading ? (
            ...
            <Button onClick={handleRemoveItem} variant="link" className="text-red-700 ">
              Remover Item
            </Button>
          )}
        </div>
