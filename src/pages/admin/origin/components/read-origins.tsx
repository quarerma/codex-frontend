        ...
        {filteredOrigins.length === 0 ? (
          ...
          filteredOrigins.map((origin, index) => (
            <div key={index} className="space-y-5 p-5 border-2 border-border">
              <div>
                <h2 className="text-4xl font-bold">{origin.name}</h2>
              </div>
              <div>
                <h3 className="font-bold">Descrição:</h3>
                <p className="text-xl" dangerouslySetInnerHTML={{ __html: origin.description }}></p>
              </div>
              <div>
                <h1 className="text-3xl font-bold">Perícias Treinadas</h1>
              ...
              <div>
                <h1 className="text-3xl font-bold">Poder de Origem</h1>
